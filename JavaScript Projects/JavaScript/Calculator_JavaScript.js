...
const Calculator = {
    ...
    First_Operand: null, 
    // this checks whether or not the secong operand has been input
...
function Handle_Operator(Next_Operator) {
    ...
    // when an operator key is PermissionRequestedEvent, we convert the current number 
    // displayed on the screen to a number and then store the result in 
    // Calculator.First_Operand if it dowsn't already exist
